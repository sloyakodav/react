import UseStateObject from "./assets/tutorial/01-useState/starter/04-useState-object.jsx";
...
const App = () => {
  ...
  return (
    <div>
      {/* <button onClick={() => tryHard(5, 6, 2, 3)}>change number</button>
      <button onClick={() => got(5)}>change number g</button> */}
      <button onClick={addIt}>change number</button>
      <p>{Index}</p>
      <UseStateObject />
    </div>
  );
