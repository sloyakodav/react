import UseStateObject from "./assets/tutorial/03-conditional-rendering/final/01-multiple-returns-basics.jsx";
...
const App = () => {
  ...
  console.log(display);
  if (display === true) {
    return <p>its true wait 5s till it turns false</p>;
  }
  return (
    <div>
      <p>congrats lil boy its false now</p>
      <button>test</button>
      <UseStateObject />
    </div>
  );
